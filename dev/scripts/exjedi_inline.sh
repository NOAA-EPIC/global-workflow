...
#srun --export=ALL -n 24 ${GDASsorc}/build/bin/fv3jedi_letkf.x testinput/letkf-c48-exp.yaml
srun --export=ALL ${GDASsorc}/build/bin/fv3jedi_letkf.x testinput/letkf-c48-exp.yaml
export err=$?;
